...
of_features <- c('frame', 'timestamp', 'AU06_r', 'AU12_r')
fr_cols <- c(24, 28)
...
## bind rows
expt4_of <- bind_rows(of_pitch_1, of_pitch_2, of_pitch_3, of_pitch_4, 
...
expt4_fr <- bind_rows(fr_pitch_1, fr_pitch_2, fr_pitch_3, fr_pitch_4, 
...
## save files
write.csv(expt4_of, file = 'expt4_of.csv')
write.csv(expt4_fr, file = 'expt4_fr.csv')
# ---------------------------------------------------------------------------- #