...
of_features <- c('frame', 'timestamp', 'AU01_r', 'AU02_r', 'AU04_r', 'AU05_r', 
                  'AU06_r', 'AU07_r', 'AU10_r', 'AU12_r', 'AU14_r', 'AU15_r', 
                  'AU17_r', 'AU20_r', 'AU23_r', 'AU25_r', 'AU26_r')
fr_cols <- c(1, 20:25, 27:31, 33, 34, 36, 37)
...
## bind rows
expt1_of <- bind_rows(of_pitch_1, of_pitch_2, of_pitch_3, of_pitch_4, 
...
expt1_fr <- bind_rows(fr_pitch_1, fr_pitch_2, fr_pitch_3, fr_pitch_4, 
...
## save files
write.csv(expt1_of, file = 'expt1_of.csv')
write.csv(expt1_fr, file = 'expt1_fr.csv')
# ---------------------------------------------------------------------------- #