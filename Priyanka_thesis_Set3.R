...
## bind rows
expt3_of <- bind_rows(of_pitch_1, of_pitch_2, of_pitch_3, of_pitch_4, 
...
expt3_fr <- bind_rows(fr_pitch_1, fr_pitch_2, fr_pitch_3, fr_pitch_4, 
...
expt3_of <- expt3_of %>%
  mutate(happy = AU06_r + AU12_r,
         sad = AU01_r + AU04_r + AU15_r,
         angry = AU04_r + AU05_r + AU07_r + AU23_r,
         scared = AU01_r + AU02_r + AU04_r + 
           AU05_r + AU07_r + AU20_r +AU26_r) %>%
  select(-(of_features))
...
## save files
write.csv(expt3_of, file = 'expt3_of.csv')
write.csv(expt3_fr, file = 'expt3_fr.csv')
# ---------------------------------------------------------------------------- #